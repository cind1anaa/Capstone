...
<body>
    ...
    <div class="table-section">
      <div class="mb-3 d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-2">
          <div class="search-bar" style="background-color:#cfe2c3;padding:8px 15px;border-radius:25px;display:flex;align-items:center;width:300px;">
            <i class="bi bi-search me-2"></i>
            <input type="text" id="searchInput" placeholder="Search by any field..." style="border:none;background:transparent;outline:none;flex:1;font-size:14px;" />
          </div>
          <button class="btn btn-outline-success btn-sm" id="sortToggle" data-sort-col="2" title="Sort by Collection Date">
  ...
  <script>
    // Search and Sort behavior for history table
    (function(){
